  ...
  return(
    ...
    <div>
      <div className="flex flex-col text-gray-50 ">
        ...
        <Project title="UNIWEB-ACCESS" skills="REACT, REDUX, MATERIAL UI, CHART.JS, D3, PUPPETIER, POSTGRES SQL, CHAI, FIREBASE" githubLink="https://github.com/uniwebaccess/Capstone" webLink="http://uniweb-access.herokuapp.com/" className="pb-5" >
          ...
          <div className="pt-5 grid md:grid-cols-4 md:gap-2 grid-cols-2 gap-2">
            <ProjectImage  className="w-64" small="./uniwebScrinshots/uniweb1small.png" big="./uniwebScrinshots/uniweb1.png"></ProjectImage>
            <ProjectImage className="w-64" small="./uniwebScrinshots/uniweb2small.png" big="./uniwebScrinshots/uniweb2.png"></ProjectImage>
            <ProjectImage className="w-64" small="./uniwebScrinshots/uniweb3small.png" big="./uniwebScrinshots/uniweb3.png"></ProjectImage>
            <ProjectImage className="w-64" small="./uniwebScrinshots/uniweb4small.png" big="./uniwebScrinshots/uniweb4.png"></ProjectImage>
          </div>
        </Project>

        <Project title="TASTY LIST" skills="REACT NATIVE, REDUX, REACT NATIVE PAPER, EXPO" githubLink="https://github.com/vanderwooodsen/React-Native-Recipes" className="pb-5" >
          ...
          <div className="pt-5 flex flex-row items-center justify-between">
            <ProjectImage className="w-64" small="./tastyList/tastyList1sm.png" big="./tastyList/tastyList1sm.png"></ProjectImage>
            <ProjectImage className="w-64" small="./tastyList/tastyList2sm.png" big="./tastyList/tastyList2sm.png"></ProjectImage>
            <ProjectImage className="w-64" small="./tastyList/tastyList3sm.png" big="./tastyList/tastyList3sm.png"></ProjectImage>
            <ProjectImage className="w-64" small="./tastyList/tastyList4sm.png" big="./tastyList/tastyList4sm.png"></ProjectImage>
          </div>
        </Project>

        <Project title="GITHUB ORGANIZATION VIEWER" skills="REACT, REDUX, TAILWIND" githubLink="https://github.com/vanderwooodsen/Github-Organization-Viewer" webLink="https://christis.page/Github-Organization-Viewer/" className="pb-5" >
          ...
          <div className="pt-5 grid md:grid-cols-4 md:gap-2 grid-cols-2 gap-2">
            <ProjectImage small="./githubScrinshots/github1sm.png" big="./githubScrinshots/github1.png"></ProjectImage>
            <ProjectImage small="./githubScrinshots/github2sm.png" big="./githubScrinshots/github2.png"></ProjectImage>
          </div>
        </Project>
        ...
        <Project title="LEAFLY" skills="REACT, REDUX, BULMA, CSS, EXPRESS, POSTGRE SQL, CHAI, HEROKU, TRAVIS CI" githubLink="https://github.com/Genius-Guava/Leafly" webLink="https://gg-graceshopper.herokuapp.com/"  >
          ...
          <div className="pt-5 grid md:grid-cols-4 md:gap-2 grid-cols-2 gap-2">
            <ProjectImage className="w-64" small="./leaflyScrinshots/leafly1sm.png" big="./leaflyScrinshots/leafly1.png"></ProjectImage>
            <ProjectImage className="w-64" small="./leaflyScrinshots/leafly2sm.png" big="./leaflyScrinshots/leafly2.png"></ProjectImage>
            <ProjectImage className="w-64" small="./leaflyScrinshots/leafly3sm.png" big="./leaflyScrinshots/leafly3.png"></ProjectImage>
            <ProjectImage className="w-64" small="./leaflyScrinshots/leafly4sm.png" big="./leaflyScrinshots/leafly4.png"></ProjectImage>
          </div>
        </Project>
